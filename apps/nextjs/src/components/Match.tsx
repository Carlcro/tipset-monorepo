  ...
  return (
    <div
      className={
        mode === "placedBet"
          ? finalsStage
            ? "mb-1 grid grid-cols-[minmax(75px,_1fr)_90px_70px_minmax(70px,_1fr)] md:grid-cols-[85px_110px_90px_110px_100px] lg:grid-cols-[100px_150px_90px_90px_150px_1fr]"
